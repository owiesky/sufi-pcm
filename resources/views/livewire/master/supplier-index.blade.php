<div>
    ...
    <x-mary-header title="Supplier Index" subtitle="Manajemen Data">
    ...
    <x-mary-table :headers="$headers" :rows="$suppliers" with-pagination >
        ...
        <div class="flex justify-center">
            <x-mary-button icon="o-pencil" wire:click="edit({{ $supplier->id }})" spinner class="btn-sm" />
            <x-mary-button icon="o-trash" wire:click="delete({{ $supplier->id }})" spinner class="btn-sm" />
        </div>
        @endscope
    </x-mary-table>

    <x-mary-modal  wire:model="showSupplierModal" title="Detail Info" separator>
        <div>
